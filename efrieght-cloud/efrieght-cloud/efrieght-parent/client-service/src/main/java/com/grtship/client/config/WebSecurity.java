 ...
 * 
 */
package com.grtship.client.config;
...
import com.grtship.client.audit.SpringSecurityAuditorAware;
import com.grtship.client.filter.JWTAuthorizationFilter;
import com.grtship.client.filter.ServiceContextFilter;
...
public class WebSecurity extends WebSecurityConfigurerAdapter {
	...
	String[] urls = {"/actuator/**","/management/**","/v2/**","/swagger-resources/**","/webjars/**","/swagger-ui/**" };
